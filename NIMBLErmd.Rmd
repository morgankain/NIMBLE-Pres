...
```{r, echo=FALSE}
beta <- 0.00015; pop <- 5000; gamma = 0.01; end = 20; report = 0.8; nchain = 3
...
Place 'jagsSIRmodel.bug' in your working directory
...
Run some chains
```{r}
update(SIRmodel, n.iter = 500, by = 25, progress.bar = "text")
```
